...
CocktailResponse _$CocktailResponseFromJson(Map<String, dynamic> json) =>
    CocktailResponse(
      ...
      instructionsZhHans: json['strInstructionsZH-HANS'] as String?,
      instructionsZhHant: json['strInstructionsZH-HANT'] as String?,
...
Map<String, dynamic> _$CocktailResponseToJson(CocktailResponse instance) =>
    <String, dynamic>{
      ...
      'strInstructionsZH-HANS': instance.instructionsZhHans,
      'strInstructionsZH-HANT': instance.instructionsZhHant,
